 ...
 * Efan as my meteor username/module, and
 * ChatController for my controllername
 */
Namespace('Efan.ChatController');
 ...
 */
Efan.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return Efan.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        Efan.Chat.insert(doc, function(err, _id) {
            if (err) {
