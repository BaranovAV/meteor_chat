 ...
 * in my case is Efan who is my meteor username, and
 ...
 * in my case my collection name will be "efan_chat"
 * this is to avoid crash between another collection name called "chat"
 */
Efan.Chat = new Mongo.Collection("efan_chat");
...
Efan.Chat.attachSchema(schemas);
