 ...
 */
var ctrl = new Efan.ChatController();

/*
 * subscribe chat from server with criteria from controller and sort limit from controller
 * when template created
 */
Template.efan_chatIndex.onCreated(function() {
    var self = this;
    self.autorun(function() {
        self.subscribe('efan_chat', ctrl.getCriteria(), ctrl.getSortLimit());
    });
});

Template.efan_chatIndex.helpers({
...
Template.efan_chatIndex.events = {
